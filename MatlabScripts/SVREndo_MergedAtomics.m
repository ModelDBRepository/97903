...
% Filename: SVREndo_MergedAtomics.m
...
f1=openfig('..\Output\CSESVREndoD__CombinedContours_Dye_SVR_EndogenousBuffer_Plot.fig');
axeshandle2=gca
f2=openfig('..\Output\CSESVREndoS__CombinedContours_Dye_SVR_EndogenousBuffer_Plot.fig');
axeshandle3=gca
f3=openfig('..\Output\CSESVREndoD__DecayTimes_Dye_SVR_EndogenousBuffer_Plot.fig');
axeshandle4=gca
f4=openfig('..\Output\CSESVREndoS__DecayTimes_Dye_SVR_EndogenousBuffer_Plot.fig');
axeshandle5=gca
f5=openfig('..\Output\CSESVREndoD__RiseTimes_Dye_SVR_EndogenousBuffer_Plot.fig');
axeshandle6=gca
f6=openfig('..\Output\CSESVREndoS__RiseTimes_Dye_SVR_EndogenousBuffer_Plot.fig');
axeshandle7=gca
...
saveas(gcf, '..\Output\SVREndo_CombinedFigures','fig')
saveas(gcf, '..\Output\SVREndo_CombinedFigures','png')
saveas(gcf, '..\Output\SVREndo_CombinedFigures','pdf')
