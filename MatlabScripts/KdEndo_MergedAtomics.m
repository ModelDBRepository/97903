...
% Filename: KdEndo_MergedAtomics.m
...
f1=openfig('..\Output\CSEKdEndoD__CombinedContours_Dye_Kd_EndogenousBuffer_Plot.fig');
axeshandle2=gca
f2=openfig('..\Output\CSEKdEndoS__CombinedContours_Dye_Kd_EndogenousBuffer_Plot.fig');
axeshandle3=gca
f3=openfig('..\Output\CSEKdEndoD__DecayTimes_Dye_Kd_EndogenousBuffer_Plot.fig');
axeshandle4=gca
f4=openfig('..\Output\CSEKdEndoS__DecayTimes_Dye_Kd_EndogenousBuffer_Plot.fig');
axeshandle5=gca
f5=openfig('..\Output\CSEKdEndoD__RiseTimes_Dye_Kd_EndogenousBuffer_Plot.fig');
axeshandle6=gca
f6=openfig('..\Output\CSEKdEndoS__RiseTimes_Dye_Kd_EndogenousBuffer_Plot.fig');
axeshandle7=gca
...
%         text(.4,9000,['\color{white}\bf\fontsize{16}D'])
         set(get(axeshandle6,'Ylabel'),'String', 'K_{d,endo} (\muM)','FontWeight',FontWeight)
...
%         set(get(axeshandle7,'Ylabel'),'String', 'K_{off,endo} (ms^{-1})','FontWeight',FontWeight)
        set(get(axeshandle7,'Ylabel'),'String', 'K_{d,endo} (\muM)','FontWeight',FontWeight)
...
saveas(gcf, '..\Output\KdEndo_CombinedFigures','fig')
saveas(gcf, '..\Output\KdEndo_CombinedFigures','png')
saveas(gcf, '..\Output\KdEndo_CombinedFigures','pdf')
