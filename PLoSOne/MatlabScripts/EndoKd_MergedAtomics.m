...
% Filename: EndoKd_MergedAtomics.m
...
f1=openfig('..\Output\CSEEndoKdD__CombinedContours_Dye_Total_EndogenousBuffer_Plot.fig');
axeshandle2=gca
f2=openfig('..\Output\CSEEndoKdS__CombinedContours_Dye_Total_EndogenousBuffer_Plot.fig');
axeshandle3=gca
f3=openfig('..\Output\CSEEndoKdD__DecayTimes_Dye_Total_EndogenousBuffer_Plot.fig');
axeshandle4=gca
f4=openfig('..\Output\CSEEndoKdS__DecayTimes_Dye_Total_EndogenousBuffer_Plot.fig');
axeshandle5=gca
f5=openfig('..\Output\CSEEndoKdD__RiseTimes_Dye_Total_EndogenousBuffer_Plot.fig');
axeshandle6=gca
f6=openfig('..\Output\CSEEndoKdS__RiseTimes_Dye_Total_EndogenousBuffer_Plot.fig');
axeshandle7=gca
...
%         text(.4,9000,['\color{white}\bf\fontsize{16}E'])
        set(get(axeshandle4,'Xlabel'),'String', 'K_{d,endo} (\muM)','FontWeight',FontWeight)
...
%         text(.4,9000,['\color{white}\bf\fontsize{16}D'])
        set(get(axeshandle6,'Ylabel'),'String', 'Endogenous Buffer (\muM)','FontWeight',FontWeight)
...
%         set(get(axeshandle7,'Ylabel'),'String', 'K_{off,endo} (ms^{-1})','FontWeight',FontWeight)
        set(get(axeshandle7,'Ylabel'),'String', 'Endogenous Buffer (\muM)','FontWeight',FontWeight)
...
saveas(gcf, '..\Output\EndoKd_CombinedFigures','fig')
saveas(gcf, '..\Output\EndoKd_CombinedFigures','png')
saveas(gcf, '..\Output\EndoKd_CombinedFigures','pdf')
